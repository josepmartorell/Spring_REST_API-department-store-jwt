...
public class Cash implements Serializable {
     ...
     *
     * @param aFloor the new value for floor
     */
    ...
    /**
     * Compares the key for this instance with another Cash.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class Cash and the key objects are equal
     */
    ...
    /**
     * Compares this instance with another Cash.
     *
     * @param other The object to compare to
    ...
    public boolean equals(Object other) {
        ...
        return this.equalKeys(other) && ((Cash)other).equalKeys(this);
    }
